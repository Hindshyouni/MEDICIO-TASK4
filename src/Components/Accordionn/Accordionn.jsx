  ...
  return (
    <div className='doctor-bg-color'>
      ...
      <Accordion.Item eventKey="0" className='mb-4'>
        <Accordion.Header>Non quod quo quos nulla quo illum ullam?</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="1" className='mb-4'>
        <Accordion.Header>Feugiuatquod quo quos nulla quo illum ullam?</Accordion.Header>
        <Accordion.Body>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="2" className='mb-4'>
        <Accordion.Header>Dolor quod quo quos nulla quo illum ullam?</Accordion.Header>
        <Accordion.Body>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="3" className='mb-4'>
        <Accordion.Header>Ac odio quod quo quos nulla quo illum ullam?</Accordion.Header>
        <Accordion.Body>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <Accordion.Item eventKey="4" className='mb-4'>
        <Accordion.Header>Tempus quod quo quos nulla quo illum ullam?</Accordion.Header>
        <Accordion.Body>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
